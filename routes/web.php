...
Route::middleware(['setlocale'])->group(function () {
    ...
    Route::post('/checkout', [CartController::class, 'placeOrder'])->name('checkout.place')->middleware(['auth', 'checkout.block']);
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware(['auth', 'admin'])->group(function () {
            ...
            Route::resource('announcements', AdminAnnouncementController::class)->except(['show'])->middleware('permission:Web_Settings');
            ...
            Route::post('warehouse/picking-orders/{warehousePickingOrder}/complete', [WarehouseController::class, 'completePicking'])->name('warehouse.picking-orders.complete')->middleware('permission:manage warehouse');
